...
public class GuiPasswordField extends Gui
{
    ...
    private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_)
    {
		...
		VertexBuffer vertexbuffer = var6.getBuffer();
        GL11.glColor4f(0.0F, 0.0F, 255.0F, 255.0F);
        GL11.glDisable(GL11.GL_TEXTURE_2D);
        GL11.glEnable(GL11.GL_COLOR_LOGIC_OP);
        GL11.glLogicOp(GL11.GL_OR_REVERSE);
        vertexbuffer.begin(7,DefaultVertexFormats.POSITION_TEX);
        vertexbuffer.pos((double)p_146188_1_, (double)p_146188_4_, 0.0D);
        vertexbuffer.pos((double)p_146188_3_, (double)p_146188_4_, 0.0D);
        vertexbuffer.pos((double)p_146188_3_, (double)p_146188_2_, 0.0D);
        vertexbuffer.pos((double)p_146188_1_, (double)p_146188_2_, 0.0D);
        var6.draw();
